...
KEEP extern const touchgfx::KerningNode kerning_GeogrotesqueCyr_SemiBold_40_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    { 0x002D, -2 },  // (First char = [0x002D, hyphen], Second char = [0x002C, comma], Kerning dist = -2)
    { 0x0037, -3 },  // (First char = [0x0037, seven], Second char = [0x002C, comma], Kerning dist = -3)
    { 0x002C, -2 },  // (First char = [0x002C, comma], Second char = [0x002D, hyphen], Kerning dist = -2)
    ...
    { 0x0032, -1 },  // (First char = [0x0032, two], Second char = [0x002D, hyphen], Kerning dist = -1)
    { 0x0037, -1 },  // (First char = [0x0037, seven], Second char = [0x002D, hyphen], Kerning dist = -1)
    { 0x002D, -2 },  // (First char = [0x002D, hyphen], Second char = [0x002E, period], Kerning dist = -2)
